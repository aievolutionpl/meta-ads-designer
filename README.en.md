...
└── references/
    ...
    ├── artifact-control.md         # The 8 artifact modes + preservation contract (R40, R41)
...
| `references/artifact-control.md` | Clean renders + safe edits: 8 artifact modes, preservation contract, recovery (R40, R41) |
