...
- **Style atlas 2026** — twenty-six visual languages, from oversized type posters and direct-flash editorial to notes-app natives, performance stickers and tactile zines, each with its type, colour, signature device, a prompt fragment and the way it fails.
...
| [Style atlas 2026](references/style-atlas-2026.md) | Twenty-six visual languages, trend slop, reading reference boards |
