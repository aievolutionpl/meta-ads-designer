...
| Your question | Open |
|---------------|------|
| What are the rules? | [`visual-advertising-engine.md`](visual-advertising-engine.md) — R01–R51, authoritative |
...
## 4 · The two production modes (R50: generation is the default)

R50 overrides this section: final ads are generated by the image model with their text; deterministic composition runs only on explicit request.
