...
**Framework-agnostic.** This is the deepest, most authoritative layer of the **Art Director** plugin. `design-rules.md` is the readable charter; **this is the operating standard** every agent should follow before producing any commercial visual.
...
Every visual should fulfil **at least one** goal:
- stop attention
- show the product
- show the problem
- show the use case
...
The user should understand within about a second:
- what they see
...
## 3 · REFERENCE IMAGE = SOURCE OF TRUTH
...
**The most important style:** professional commercial photography. **Not:** "obvious AI-generated advertisement".
...
## 6 · ONE CREATIVE = ONE IDEA

Each ad should have **one main message**. Don't try to show at once: product + 7 benefits + promotion + reviews + instructions + parameters + company story + CTA.
...
## 9 · LIGHTING IS PART OF THE PRODUCT

Don't just write "professional lighting". Say **exactly what the light does**.
...
## 10 · THINK LIKE A PHOTOGRAPHER

Every good prompt should make a **camera decision**. Don't leave everything to the generator. Decide: camera position · angle · distance · lens character · depth of field · foreground · midground · background.
...
Avoid flat images. Good commercial photography often has **foreground → subject → background**. Example: a softly blurred element in front → the main product sharp → subtle environment behind. Gives natural depth and a more photographic character.

---

## 12 · SHOW PRODUCT IN USE
...
The face doesn't always have to be visible. Sometimes a **hand, silhouette, gesture, POV or detail** gives enough context.

---

## 13 · THREE MANDATORY MARKETING ANGLES

For every product prepare **at least three directions**:
- **PROBLEM** — show the frustration or situation *before* using the product. Example: a hard-to-reach upper cabinet.
- **EFFECT** — show the result. Example: the shelf drops exactly to the user's height.
- **LIFESTYLE** — show how the product fits into a better life. Example: elegant kitchen, calm morning, user comfortably reaches for spices.

---

## 14 · VISUAL CREATIVE LIBRARY

The agent should generate **many different directions**, not repeat the same packshot. Basic set:
...
04. **PRODUCT IN USE** — the product's most important function shown in one moment.
...
07. **RESULT** — show the effect of using it above all.
...
## 15 · FOOD REQUIRES DIFFERENT RULES

Food advertising should primarily **build appetite**. Priorities: texture · steam · sauce · gloss · crunchiness · juiciness · freshness · layers · ingredients.
...
## 17 · TYPOGRAPHY COMES AFTER THE IMAGE

First prepare a strong photograph, **then** design the ad. Preferred hierarchy:
...
## 18 · DO NOT GENERATE IMPORTANT TEXT INSIDE IMAGE

If the generator handles text poorly: generate a clean visual · add real typography later · use the real logo as an asset. Don't let the model invent: logos · prices · product names · slogans · labels.
...
> Don't generate one image and hope random cropping solves every placement. Compose for the specific format.

---

## 20 · SERIES MUST HAVE CONSISTENCY
...
## 21 · CREATE VARIATION, NOT RANDOMNESS
...
Use Before/After **only when it instantly shows the product's value**. Examples: chaos → order · dark → light · dirty → clean · inconvenient access → product at hand height. Don't do before/after just because it's a popular format.

---

## 23 · GOOD SCROLL STOPPERS

Scroll-stopping doesn't mean "add more effects". You can stop attention through: an unusual perspective · extreme close-up · a moment of action · frozen motion · interesting foreground · strong scale contrast · unexpected context · a very simple composition · a face or gesture · showing the problem.

---

## 24 · BUILD THE SCENE AROUND THE BENEFIT

Don't start with "make a beautiful kitchen". Start with **"what should this ad say?"**. If the benefit is convenience → build a scene of convenience. Premium → a scene of quality. Speed → show the time-saving moment. Taste → show the food's texture. **Message first. Scene second.**

---

## 25 · PROMPT ARCHITECTURE

Every final prompt should have a logical structure:
...
## 26 · EXAMPLE OF A WEAK PROMPT

> "Create a beautiful premium ad for this product in a modern luxury environment with cinematic lighting."

This is too little. The generator has to invent almost everything.

---

## 27 · EXAMPLE OF A STRONG PROMPT
...
## 28 · CREATIVE GENERATION WORKFLOW

The agent should **not** immediately write the prompt. First:

1. **Identify the product.**
2. **Identify the most important benefit.**
3. **Define the target.**
4. **Choose the marketing angle** — Problem / Effect / Lifestyle.
5. **Invent a simple visual metaphor or situation.**
6. **Choose the creative type.**
7. **Design the composition.**
8. **Define the light and camera.**
9. **Add constraints.**
10. **Only now write the final prompt.**

---

## 29 · SELF-CRITIQUE

After generating a concept, the agent should evaluate it. Questions:
...
## 30 · HARD FAIL CONDITIONS

Automatically reject a visual if:
- the product changed construction
- the logo is wrong
- the lettering is fake
- hands are deformed
- the product's physics is wrong
- the product is too small
- the image is chaotic
- there's too much UI or icons
- the background draws more attention than the product
- it looks like stock AI
- elements have no logical function
- the ad tries to convey too many things

---

## 31 · THE REMOVAL TEST

After preparing an image or prompt, run the test: **"Can I remove something without worsening the message?"** If yes — remove it. A simpler creative with a strong idea beats a complicated one without a clear purpose.

---

## 32 · DESIGNER TEST

Before approval, imagine the visual goes to: Apple · Nike · IKEA · a premium restaurant · a high-end architecture brand · a professional ad agency. Don't copy those brands. Just ask: **"Would an art director accept the photography quality, hierarchy and composition?"** If not — improve the visual.

---

## 33 · META ADS TEST

Mentally shrink the image to a phone screen. Check: do I still understand the ad? · is the product visible? · does the focal point still work? · can the headline be read? · does the scene stop attention? If the ad only works on a big monitor, it isn't well designed for social media.

---

## 34 · FINAL QUALITY CHECK

Every visual must pass this checklist before acceptance:

- [ ] One clear goal
- [ ] One main focal point
- [ ] Product immediately visible
- [ ] Product 1:1 with the reference
- [ ] Correct perspective
- [ ] Realistic materials
- [ ] Realistic light
- [ ] Realistic shadows
...
- [ ] Clear marketing angle
- [ ] Visual works even without copy
- [ ] Format matches the placement
- [ ] The whole looks like a professional ad
