...
> **R50 note (6.0):** every final ad is generated by the image model. Where a case below gives a "typesetting handoff" or Mode B composition, fold that copy, type and placement into the generation prompt as quoted text. Use a separate typesetting step only if the user explicitly asks for one.
